...
public class Checkout {
	...
	public Checkout(int _IdCheckout, String _Nome, String _Sobrenome, String _Email, String _Endereco,
			String _Complemento, String _Pais, String _Estado, String _Cep, String _PrecoPassagem,
			String _FormasPagamento, Hoteis _Hoteis, Voos _Voos, Promocoes _Promocoes, Destinos _Destinos) {
	...
	public void setPrecoPassagem(String _PrecoPassagem) {
		this.PrecoPassagem = _PrecoPassagem;
	}
	...
	public void setFormasPagamento(String _FormasPagamento) {
		this.FormasPagamento = _FormasPagamento;
	}
